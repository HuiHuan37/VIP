...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://github.moeyy.xyz/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Conf/Qinglong/config.sample.sh)
...
# 获取有效 gitfix.sh 链接
get_valid_git() {
    git_list=(https://github.moeyy.xyz/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Scripts/sh/gitfix.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://github.moeyy.xyz/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Tasks/qlrepo/extra.sh)
...
get_valid_sendNotify() {
    sendNotify_list=(https://github.moeyy.xyz/https://raw.githubusercontent.com/shufflewzc/faker2/main/sendNotify.js)  # 替换为实际链接
